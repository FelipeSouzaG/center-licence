...
type ViewKey = "overview" | "tenants" | "leads" | "owner_home" | "owner_payments" | "owner_system";
    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        <header className="topbar">
          <div>
            ...
            <p>
              {user.role === "ADMIN"
                ? view === "leads"
                  ? "Encontre empresas, qualifique oportunidades e prepare abordagens consultivas."
          ...
          {user.role === "ADMIN" && view === "leads" ? null : <div className="topbar-actions">
            {user.role === "ADMIN" ? (
        ...
        {user.role === "ADMIN" && view === "overview" ? (
          <DashboardPage loading={loading} stats={stats} tenants={tenants} />
        ) : null}
        ...
        {user.role === "ADMIN" && view === "tenants" ? (
          <TenantsPage
            ...
            onDueDayFilterChange={setDueDayFilter}
            onEditTenant={openEditTenantModal}
            onManageOwner={openManageOwnerModal}
            onManualRenew={handleManualRenew}
            onOpenDetails={openTenantDetails}
            onPricingDraftChange={(tenantId, value) =>
        ...
        {user.role === "ADMIN" && view === "leads" ? (
          <LeadsPage onToast={addToast} />
        ) : null}

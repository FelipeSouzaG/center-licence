...
export default function GooglePlacesUsagePanel({
  ...
  return (
    <section className="panel places-usage-panel">
      ...
      <p className="places-usage-note">
        Limite interno conservador: 800 de 1.000 eventos gratuitos mensais estimados. Essa trava deixa o caçador de leads protegido para operar dentro da margem gratuita.
      </p>
